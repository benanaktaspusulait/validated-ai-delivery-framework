...
Recommended override log event:
...
/api/v1/teams:
  get:
    description: List teams and AI delivery health summaries

/api/v1/teams/{teamId}/metrics:
  get:
    description: Get metric snapshots for a team
    query:
      - sprint
      - date_from
      - date_to
...
/api/v1/teams/{teamId}/recommendations:
  get:
    description: Get open recommendations for a team

/api/v1/pull-requests/{prId}/risk:
  get:
    description: Get contextual AI delivery risk for a PR

/api/v1/policies:
  get:
    description: List active AI delivery policies
  post:
    description: Create or update AI delivery policy

/api/v1/policy-overrides:
  get:
    description: List policy overrides for audit and trend analysis
  post:
    description: Record an approved policy override
...
```text
validated-ai-delivery-platform/
  README.md
  docs/
    framework-v1.8.md
    quick-start.md
    operating-model.md
    metrics-catalogue.md
